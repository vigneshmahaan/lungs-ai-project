...
import { ArrowRight, ShieldCheck, Zap, BarChart3, Cpu } from "lucide-react";
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-balance text-5xl font-bold tracking-tight text-slate-900 sm:text-6xl">
                Classify respiratory diseases from sound.
              </h1>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border border-sky-100 bg-white/50 p-4 backdrop-blur sm:p-5">
                <div className="flex items-start gap-3">
                  <div className="rounded-lg bg-sky-100 p-2.5 text-sky-700">
                    <Cpu className="h-5 w-5" />
                  </div>
                  <div>
                    <div className="font-semibold text-slate-900">Advanced CNN</div>
                    <div className="text-xs text-slate-600">Deep learning model</div>
                  </div>
                </div>
              </div>
              <div className="rounded-2xl border border-sky-100 bg-white/50 p-4 backdrop-blur sm:p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-slate-900">Real-time Analysis</div>
                    <div className="text-xs text-slate-600">Instant results</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 pt-4 sm:flex-row sm:items-center">
              ...
              >
                Analyze Now <ArrowRight className="h-5 w-5" />
              </Link>
              <Link
                href="#how-it-works"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
              Our system processes audio through multiple stages of analysis
            </p>
          </div>

          <div className="grid gap-8 md:grid-cols-3">
            {[
              { num: "01", title: "Audio Processing", desc: "Resample, denoise, normalize audio to 16kHz" },
              { num: "02", title: "Feature Extraction", desc: "Extract MFCC & Mel-spectrogram features" },
              { num: "03", title: "AI Prediction", desc: "CNN model predicts disease with confidence" },
            ].map((item) => (
              <div key={item.num} className="rounded-2xl border border-slate-200 bg-white p-8 hover:shadow-lg transition">
                <div className="text-3xl font-bold text-sky-600 mb-4">{item.num}</div>
